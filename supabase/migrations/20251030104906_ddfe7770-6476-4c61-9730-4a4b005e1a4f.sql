-- Fix CAPEX bulk calculation: Remove total_investment from UPDATE
-- The calculate_capex_total_investment trigger handles this automatically
...
BEGIN
  ...
  LOOP
    ...
    -- Note: total_investment is NOT updated here - the trigger handles it
