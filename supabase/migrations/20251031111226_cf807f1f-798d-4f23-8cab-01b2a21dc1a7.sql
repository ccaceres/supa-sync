-- Fix CAPEX depreciation trigger to respond to investment override changes

-- Drop existing trigger
DROP TRIGGER IF EXISTS trigger_update_capex_depreciation ON capex_lines;

-- Update the depreciation function to calculate from investment_year_X columns
...
DECLARE
  ...
  deprec_yrs INTEGER;
BEGIN
  -- Calculate base cost from SUM of all investment year columns (includes overrides)
  base_cost := COALESCE(NEW.investment_year_1, 0) +
               COALESCE(NEW.investment_year_2, 0) +
               COALESCE(NEW.investment_year_3, 0) +
               COALESCE(NEW.investment_year_4, 0) +
               COALESCE(NEW.investment_year_5, 0) +
               COALESCE(NEW.investment_year_6, 0) +
               COALESCE(NEW.investment_year_7, 0) +
               COALESCE(NEW.investment_year_8, 0) +
               COALESCE(NEW.investment_year_9, 0) +
               COALESCE(NEW.investment_year_10, 0) +
               COALESCE(NEW.investment_year_11, 0) +
               COALESCE(NEW.investment_year_12, 0) +
               COALESCE(NEW.investment_year_13, 0) +
               COALESCE(NEW.investment_year_14, 0) +
               COALESCE(NEW.investment_year_15, 0) +
               COALESCE(NEW.investment_year_16, 0) +
               COALESCE(NEW.investment_year_17, 0) +
               COALESCE(NEW.investment_year_18, 0) +
               COALESCE(NEW.investment_year_19, 0) +
               COALESCE(NEW.investment_year_20, 0);
  
  -- If no investment years set, fall back to quantity * unit_cost
  IF base_cost = 0 THEN
  ...
  -- Find first year with investment (earliest non-zero investment_year_X)
  investment_yr := 1;
  ...
  -- Calculate depreciation for each year (starts year AFTER investment)
...
-- Recreate trigger to monitor all investment columns
CREATE TRIGGER trigger_update_capex_depreciation
  BEFORE INSERT OR UPDATE OF 
    ...
    depreciation_years, 
    salvage_percentage,
    investment_override_year_1, investment_override_year_2, investment_override_year_3, investment_override_year_4, investment_override_year_5,
    investment_override_year_6, investment_override_year_7, investment_override_year_8, investment_override_year_9, investment_override_year_10,
    investment_override_year_11, investment_override_year_12, investment_override_year_13, investment_override_year_14, investment_override_year_15,
    investment_override_year_16, investment_override_year_17, investment_override_year_18, investment_override_year_19, investment_override_year_20,
    investment_year_1, investment_year_2, investment_year_3, investment_year_4, investment_year_5,
    investment_year_6, investment_year_7, investment_year_8, investment_year_9, investment_year_10,
    investment_year_11, investment_year_12, investment_year_13, investment_year_14, investment_year_15,
    investment_year_16, investment_year_17, investment_year_18, investment_year_19, investment_year_20
  ON capex_lines
  FOR EACH ROW
