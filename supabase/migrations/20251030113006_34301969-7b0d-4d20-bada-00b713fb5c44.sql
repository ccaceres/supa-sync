-- Add quantity_year columns to opex_lines table for per-year quantity tracking
-- This enables the dual-row system like LABEX Indirect Labor

-- Add quantity columns for each year (1-20)
ALTER TABLE public.opex_lines
  ADD COLUMN IF NOT EXISTS quantity_year_1 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_2 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_3 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_4 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_5 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_6 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_7 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_8 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_9 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_10 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_11 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_12 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_13 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_14 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_15 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_16 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_17 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_18 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_19 NUMERIC DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS quantity_year_20 NUMERIC DEFAULT NULL;

-- Migrate existing data: populate quantity_year columns from base_quantity
UPDATE public.opex_lines
SET 
  quantity_year_1 = COALESCE(base_quantity, 1),
  quantity_year_2 = COALESCE(base_quantity, 1),
  quantity_year_3 = COALESCE(base_quantity, 1),
  quantity_year_4 = COALESCE(base_quantity, 1),
  quantity_year_5 = COALESCE(base_quantity, 1),
  quantity_year_6 = COALESCE(base_quantity, 1),
  quantity_year_7 = COALESCE(base_quantity, 1),
  quantity_year_8 = COALESCE(base_quantity, 1),
  quantity_year_9 = COALESCE(base_quantity, 1),
  quantity_year_10 = COALESCE(base_quantity, 1),
  quantity_year_11 = COALESCE(base_quantity, 1),
  quantity_year_12 = COALESCE(base_quantity, 1),
  quantity_year_13 = COALESCE(base_quantity, 1),
  quantity_year_14 = COALESCE(base_quantity, 1),
  quantity_year_15 = COALESCE(base_quantity, 1),
  quantity_year_16 = COALESCE(base_quantity, 1),
  quantity_year_17 = COALESCE(base_quantity, 1),
  quantity_year_18 = COALESCE(base_quantity, 1),
  quantity_year_19 = COALESCE(base_quantity, 1),
  quantity_year_20 = COALESCE(base_quantity, 1)
WHERE quantity_year_1 IS NULL;

-- Update bulk_calculate_opex_costs to use quantity_year columns
...
BEGIN
    ...
    LOOP
        ...
        -- Apply inflation and update cost columns
        IF COALESCE(opex_record.treat_as_asset, false) = true THEN
            ...
            -- Set same average cost for all years
            UPDATE opex_lines 
            SET 
        ...
        ELSE
            -- Apply escalating costs with inflation
            UPDATE opex_lines 
            SET 
