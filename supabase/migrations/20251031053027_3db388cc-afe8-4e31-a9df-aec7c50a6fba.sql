-- Make bulk_calculate_opex_costs dynamic based on contract_years from model_parameters
-- This enables different models to have different projection periods (5, 10, 15, 20 years)
